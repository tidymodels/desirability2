...
This outlines how to propose a change to desirability2. For more
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("topepo/desirability2", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://desirability2.tidymodels.org/dev/CODE_OF_CONDUCT.md).
