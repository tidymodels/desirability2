...
We can add these as columns to the data using a
...
See
[`?inline_desirability`](https://desirability2.tidymodels.org/dev/reference/inline_desirability.md)
for details on the individual desirability functions.
...
![](reference/figures/README-choices-1.png)
...
To do this, we can use different verbs:
...
for any of the metrics *or* tuning parameters. For example:
